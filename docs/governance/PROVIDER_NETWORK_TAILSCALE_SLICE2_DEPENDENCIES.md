> **Superseded by** `docs/engine/history/PROVIDER_NETWORK_TAILSCALE_EVOLUTION.md` section 6.2. Kept for historical reference. New Tailscale evolution notes MUST go into the evolution log.
