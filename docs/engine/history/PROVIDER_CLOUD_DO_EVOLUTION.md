...
- **Coverage Plan**: `docs/governance/PROVIDER_CLOUD_DO_COVERAGE_PLAN.md` → `docs/archive/governance/`
- **Micro Plan**: `docs/governance/PROVIDER_CLOUD_DO_MICRO_PLAN.md` → `docs/archive/governance/`
- **V1 Complete Status**: `docs/engine/status/PROVIDER_CLOUD_DO_COVERAGE_V1_COMPLETE.md` → `docs/archive/status/`
