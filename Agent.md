...
## 🏴󠁶󠁵󠁭󠁡󠁰󠁿 Feature Mapping Invariant
...
Generated files MUST be ignored (.gitignore) unless versioning is required.
...
AI MUST NOT transition a PR to "ready-for-review".
