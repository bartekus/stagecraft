...
// mockProvider is a test implementation of NetworkProvider.
...
func (m *mockProvider) EnsureInstalled(ctx context.Context, opts EnsureInstalledOptions) error {
	return nil
}

func (m *mockProvider) EnsureJoined(ctx context.Context, opts EnsureJoinedOptions) error {
	return nil
}

func (m *mockProvider) NodeFQDN(host string) (string, error) {
	return host + ".test.net", nil
}
